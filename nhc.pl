...
unshift @ARGV, '--data-dir',  File::Spec->catdir('', 'Program Files', 'DreamWorks Interactive', 'Neverhood', 'DATA');
unshift @ARGV, '--share-dir', File::Spec->catdir($FindBin::Bin, 'share');
unshift @ARGV, '--normal-window';
